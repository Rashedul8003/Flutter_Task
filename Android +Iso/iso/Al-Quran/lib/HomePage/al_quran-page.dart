...
class Al_Quran extends StatefulWidget {
  const Al_Quran({Key? key}) : super(key: key);

  @override
  _Al_QuranState createState() => _Al_QuranState();
}

class _Al_QuranState extends State<Al_Quran> {
  List<Surah> surahs = [];
