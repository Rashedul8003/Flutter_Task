...
class CustomTopPaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.1790179,
        size.height * 0.8716312,
        size.width * 0.05133929,
        size.height * 0.5886525,
        size.width * 0.001116071,
        size.height * 0.4397163);
    ...
    path_0.cubicTo(
        size.width * 0.9620536,
        size.height * 1.009454,
        size.width * 0.8466518,
        size.height * 1.041844,
        size.width * 0.6796875,
        size.height * 0.8120567);
    path_0.cubicTo(
        size.width * 0.4709821,
        size.height * 0.5248227,
        size.width * 0.4241071,
        size.height * 0.7375887,
        size.width * 0.2879464,
        size.height * 0.8120567);
    path_0.close();
